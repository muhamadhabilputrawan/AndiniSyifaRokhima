...
export const experiences = [
  ...
  },
  {
    ...
    type: "TEFA",
    description: [
      "Mengelola agenda kegiatan pimpinan dan korespondensi",
      "Mengelola kas kecil dan buku kas",
      "Mengetik cepat dan menyusun notula",
  ...
  },
  {
    ...
    type: "TEFA",
    description: [
      "Bendahara Umum OSIS (2023–2024) — Mengelola keuangan organisasi, menyusun laporan keuangan, serta menangani administrasi OSIS secara terstruktur.",
      "Menyusun 13 Rencana Anggaran Biaya (RAB) kegiatan sekolah beserta laporan pertanggungjawaban selama satu periode kepengurusan",
      "Ketua Umum OSIS (2024–Sekarang) — Memimpin jalannya organisasi dan memastikan seluruh program kerja terlaksana dengan baik dan tepat sasaran.",
    ],
    icon: "🎓",
  },
  {
...
export const galleryImages = [
  {
    id: 1,
    imageKey: "kegiatan1",
    alt: "Serah Jabatan Bendahara Umum",
    caption: "Serah Jabatan Bendahara Umum",
  },
  {
    id: 2,
    imageKey: "kegiatan2",
    alt: "BPH Forum OSIS Jawa Barat",
    caption: "BPH Forum OSIS Jawa Barat",
  },
  {
    id: 3,
    imageKey: "kegiatan4",
    alt: "Kegiatan CBT",
    caption: "Kegiatan CBT",
  },
  {
    id: 4,
    imageKey: "kegiatan6",
    alt: "Aktivitas Organisasi",
  ...
  },
  {
    id: 6,
    imageKey: "kegiatan8",
    alt: "Praktik Administrasi",
    caption: "Praktik Administrasi",
  },
  {
    id: 7,
    imageKey: "kegiatan9",
    alt: "TEFA Agen BNI 46",
    caption: "TEFA Agen BNI 46",
  },
  {
    id: 8,
    imageKey: "kegiatan10",
